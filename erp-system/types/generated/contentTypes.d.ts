...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    issued_date: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::invoice.invoice'
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    purchase_order_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::purchase-order-item.purchase-order-item'
    >;
    sales_order_items: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPurchaseOrderPurchaseOrder
  ...
  attributes: {
    ...
    po_number: Schema.Attribute.UID;
...
export interface ApiSalesOrderItemSalesOrderItem
  extends Struct.CollectionTypeSchema {
  collectionName: 'sales_order_items';
  info: {
    displayName: 'SalesOrderItem';
    pluralName: 'sales-order-items';
    singularName: 'sales-order-item';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSalesOrderSalesOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    sales_order_items: Schema.Attribute.Relation<
      ...
      'api::sales-order-item.sales-order-item'
    >;
    total_number: Schema.Attribute.Decimal;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStockMovementStockMovement
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    warhouse: Schema.Attribute.Relation<'manyToOne', 'api::warhouse.warhouse'>;
  };
}
...
export interface ApiSupplierSupplier extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    conatct_info: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiWarhouseWarhouse extends Struct.CollectionTypeSchema {
  collectionName: 'warhouses';
  info: {
    displayName: 'Warhouse';
    pluralName: 'warhouses';
    singularName: 'warhouse';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sales-order-item.sales-order-item': ApiSalesOrderItemSalesOrderItem;
      ...
      'api::warhouse.warhouse': ApiWarhouseWarhouse;
